...
interface CategoryReportsBlockProps {
  transactions: any[];
}
...
export const CategoryReportsBlock: React.FC<CategoryReportsBlockProps> = ({ transactions }) => {
  // Agrupar por categoria e tipo (igual desktop)

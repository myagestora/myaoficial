...
-- Limpar completamente o usuário admin existente primeiro
DELETE FROM public.profiles WHERE id = 'f8baa6c5-57a9-4534-94f7-0d46d6b1b252';
DELETE FROM public.user_roles WHERE user_id = 'f8baa6c5-57a9-4534-94f7-0d46d6b1b252';
DELETE FROM auth.users WHERE id = 'f8baa6c5-57a9-4534-94f7-0d46d6b1b252';
...
-- Inserir categorias padrão (sem user_id específico, usando NULL para categorias padrão)
